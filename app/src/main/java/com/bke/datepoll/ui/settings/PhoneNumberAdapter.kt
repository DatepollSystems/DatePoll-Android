...
class PhoneNumberAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(), KoinComponent{
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(holder.itemViewType > 1){
            ...
            viewHolder.btnDelete.setOnClickListener {
                //TODO send delete request for phone number
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when(viewType){
            1 -> PhoneNumberHeadlineViewHolder(layoutInflater.inflate(R.layout.birthday_headline_item, parent, false))
